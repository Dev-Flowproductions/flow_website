        ...
        <div className="max-w-4xl mx-auto text-center md:text-left">
          ...
          <AnimateIn delay={0.1}>
            <div className="bg-[#5b54a0]/5 border border-[#5b54a0]/20 rounded-2xl p-8">
              ...
              <ScrollToDiagnostic targetId="gtm-readiness-diagnostic" className="inline-block px-8 py-3 bg-[#5b54a0] text-white rounded-full hover:bg-[#4a4480] transition-colors font-medium">
                {t('diagnostic.cta')}
              </ScrollToDiagnostic>
            </div>
          </AnimateIn>
